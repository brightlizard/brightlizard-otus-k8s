...
import net.brightlizard.shop.billing.infrastructure.vertx.BillingReactor;
import net.brightlizard.shop.delivery.infrastructure.vertx.DeliveryReactor;
import net.brightlizard.shop.notification.infrastructure.vertx.NotificationReactor;
import net.brightlizard.shop.payment.infrastructure.vertx.PaymentReactor;
import net.brightlizard.shop.storage.infrastructure.vertx.StorageReactor;
...
public class VertxContainer {
    ...
    private final boolean tcpipEnabled;
    private final boolean kubernetesEnabled;
    private final String kubernetesServiceDns;
